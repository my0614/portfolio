...
export const projects: Project[] = [
  {
    ...
    sections: {
      ...
      기획의도: "파트너사 담당자가 매번 수작업으로 상품을 신청하고, MD가 하루 4시간 이상을 선정·등록·결과 공유에 쏟는 구조였다. 특히 결과를 파트너사 계정별로 파일로 만들어 Gmail로 개별 발송하는 과정이 반복적이고 누락이 잦았다. OAuth 2.0을 통해 Google Spreadsheet와 Gmail을 하나의 파이프라인으로 연결해, 신청 집계·상품 매칭·선별·결과 메일 발송까지 전 과정을 코드로 자동화했다.",
      기술: [
        {
