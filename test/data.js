// Portfolio content — 김민영 (KIM MIN YOUNG), ML / MLOps Developer
window.PROFILE = {
  name: "김민영",
...
window.PROJECTS = [
  {
    ...
    thumb: "assets/projects/hotdeal-app.png",
    image: { src: "assets/projects/hotdeal-app.png", caption: "무무즈 핫딜 오픈 화면" },
    ...
    sections: {
      arch: "assets/projects/hotdeal-arch.svg",
      intent: [
  ...
  },
  {
    ...
    thumb: "assets/projects/cs-process.png",
    image: { src: "assets/projects/cs-process.png", caption: "CS 문의 자동화 프로세스" },
    ...
    sections: {
      arch: "assets/projects/cs-arch.svg",
      intent: [
  ...
  },
  {
    ...
    subtitle: "보안기관기술개발 R&D",
    company: "한컴인스페이스",
    initial: "한",
    summary: "객체 탐지 mAP 61% → 75% 달성, 네트워크 세팅 2시간 → 1분으로 단축한 정찰 드론 실시간 위협 탐지 및 3D 가시화 시스템.",
    thumb: "assets/projects/drone-detection.png",
    image: { src: "assets/projects/drone-detection.png", caption: "실시간 위협 객체 6종 클래스" },
    ...
    sections: {
      arch: "assets/projects/drone-arch.svg",
      intent: [
        ...
        "보안기관 기술 개발 과제 — KTL 시험 성적서 기준 달성이 필수 조건",
      ],
      tech: [
        {
  ...
  },
  {
    ...
    thumb: "assets/projects/dflow-training-ui.png",
    image: { src: "assets/projects/dflow-training-ui.png", caption: "모델 학습 상태 관리 (Connected → Preparing → Training)" },
    image2: { src: "assets/projects/dflow-performance.png", caption: "모델 성능 평가 대시보드" },
    ...
    sections: {
      arch: "assets/projects/dflow-arch.svg",
      intent: [
  ...
  },
  {
    ...
    thumb: "assets/projects/pillcare-thumb.webp",
    image: { src: "assets/projects/pillcare-thumb.webp", caption: "PillCare 서비스 화면" },
    ...
    sections: {
      arch: "assets/projects/pillcare-arch.svg",
      intent: [
